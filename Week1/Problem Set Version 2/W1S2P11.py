...
The function should modify the list to return the running sum 
such that superhero_stats[i] = sum(superhero_stats[0]...superhero_stats[i]). 
...
"""
def running_sum(superhero_stats):
    superhero_stats[0] = superhero_stats[0]
